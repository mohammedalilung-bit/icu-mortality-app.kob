...
if st.button("🔮 Predict Mortality", type="primary", use_container_width=True):
    ...
    if mortality_rate > 20:
        st.warning("⚠️ High mortality rate detected - review protocols")
    elif mortality_rate > 15:
        st.info("ℹ️ Moderate risk - monitor closely")
    else:
        st.success("✅ Low risk - within normal parameters")

st.sidebar.header("ℹ️ About")
st.sidebar.info("""
**ICU Mortality Prediction System**

Uses machine learning to predict mortality based on:
- APACHE II scores
- Case volumes
- Infection rates
